...
import 'package:comma_community_app/widgets/loading_widget.dart';
...
class EditProfileModalState extends ConsumerState<EditProfileModal> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      profileNotifier.fetchUserDetails();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          ...
                          await profileNotifier.saveImage(context);
                          await profileNotifier.saveProfileData();
                        },
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              buildTextField(
                                  ...
                                  160,
                                  profileController.miniBioController),
                              const SizedBox(height: 20),
                              const Text(
                                'About Me',
                                style: TextStyle(
                              ...
                              buildTextField(
                                  ...
                                  500,
                                  profileController.aboutMeController),
                              const Text(
                                'Profession',
                                style: TextStyle(
                                    fontSize: 16.0,
        ...
        if (profileController.isProfileUploading)
